package com.ljh.www.imkit.widget;
 ...
 */
public class DragSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
        NestedScrollingChild {
    private static final String TAG = LogUtils.makeLogTag(DragSwipeRefreshLayout.class.getSimpleName());
...
//        LogUtils.LOGD(TAG,"overscrollTop"+overscrollTop);
...
//        LogUtils.LOGD(TAG,"overscrollTop 2  "+(targetY - mCurrentTargetOffsetTop));
//        ViewCompat.setTranslationY(mTarget,mCurrentTargetOffsetTop);
        setTargetOffsetTopAndBottom(targetY - mCurrentTargetOffsetTop, true /* requires update */);

    }

    private void finishSpinner(float overscrollTop) {
//        LogUtils.LOGD(TAG,"finishSpinner"+overscrollTop);
////        ViewCompat.setTranslationY(mTarget,0.0f);
//        TranslateAnimation translateAnimation=new TranslateAnimation(0,0,0,-626);
